...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const [{ count: partners }, { count: events }, { count: contacts }, { count: registrations }, { count: roadtrips }, { data: payments }, { data: pendingPartners }, { data: pendingEvents }, { data: audit }, { data: analyticsSummary }] =
      await Promise.all([
